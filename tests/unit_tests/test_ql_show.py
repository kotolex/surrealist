...
class TestShow(TestCase):
    ...
    def test_create_since(self):
        ...
        self.assertEqual('SHOW CHANGES FOR TABLE person SINCE "2023-09-07T01:23:52Z";', show.to_str())
        self.assertTrue(show.is_valid())
        show = Show(None, "person").since("2024-02-06T10:48:08.700483Z")
        self.assertEqual('SHOW CHANGES FOR TABLE person SINCE "2024-02-06T10:48:08.700483Z";', show.to_str())
        self.assertTrue(show.is_valid())
    ...
    def test_invalid_full_query(self):
        ...
        self.assertEqual('SHOW CHANGES FOR TABLE person SINCE "2023-09-07T01:23:52Z" LIMIT -1;', show.to_str())
        self.assertFalse(show.is_valid())
