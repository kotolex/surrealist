...
names = [
    ...
    ("duration::from_hours", '3', "3h"),
    ("duration::from_micros", '3', "3µs"),
    ("duration::from_millis", '3', "3ms"),
    ("duration::from_mins", '3', "3m"),
    ("duration::from_nanos", '3', "3ns"),
    ("duration::from_secs", '3', "3s"),
    ("duration::from_weeks", '3', "3w"),
    ...
    ("record::id", "person:tobie", "tobie"),
    ("record::tb", "person:tobie", "person"),
    ("record::is_edge", "person:tobie", False),
    ("string::capitalize", "'hello world Goo'", "Hello World Goo"),
    ...
    ("string::slice", "'this is a test', 10", "test"),
    ...
    ("string::is_alpha", "'ABCDEF'", True),
    ("string::is_ascii", "'ABC123'", True),
    ("string::is_datetime", '"2015-09-05 23:56:04", "%Y-%m-%d %H:%M:%S"', True),
    ("string::is_domain", "'surrealdb.com'", True),
    ("string::is_email", "'info@surrealdb.com'", True),
    ("string::is_hexadecimal", "'ff009e'", True),
    ("string::is_ip", "'192.168.1.1'", True),
    ("string::is_ipv4", "'192.168.1.1'", True),
    ("string::is_ipv6", "'192.168.1.1'", False),
    ("string::is_latitude", "'-0.118092'", True),
    ("string::is_longitude", "'51.509865'", True),
    ("string::is_numeric", "'1484091748'", True),
    ("string::is_record", "'person:test'", True),
    ("string::is_record", "'person:test', 'person'", True),
    ("string::is_record", "'person:test', 'other'", False),
    ("string::is_record", "'not a record'", False),
    ("string::is_semver", '"1.0.0"', True),
    ("string::is_url", '"https://surrealdb.com"', True),
    ("string::is_uuid", '"018a6680-bef9-701b-9025-e1754f296a0f"', True),
    ...
    ("time::is_leap_year", 'd"1988-11-01T08:30:17+00:00"', True),
    ...
    ("time::from_micros", '1000000', "1970-01-01T00:00:01Z"),
    ("time::from_millis", '1000', "1970-01-01T00:00:01Z"),
    ("time::from_secs", '1000', "1970-01-01T00:16:40Z"),
    ("time::from_unix", '1000', "1970-01-01T00:16:40Z"),
    ("type::bool", 'true', True),
    ...
    ("type::is_array", "12345", False),
    ("type::is_bool", "true", True),
    ("type::is_bytes", '"I am not bytes"', False),
    ("type::is_collection", '"I am not bytes"', False),
    ("type::is_line", '"I am not bytes"', False),
    ("type::is_multiline", '"I am not bytes"', False),
    ("type::is_multipoint", '"I am not bytes"', False),
    ("type::is_multipolygon", '"I am not bytes"', False),
    ("type::is_polygon", '"I am not bytes"', False),
    ("type::is_none", 'NONE', True),
    ("type::is_null", 'NULL', True),
    ("type::is_datetime", 'time::now()', True),
    ("type::is_decimal", '<decimal> 13.5719384719', True),
    ("type::is_duration", '"1970-01-01T00:00:00"', False),
    ("type::is_float", '<float> 41.5', True),
    ("type::is_int", '41', True),
    ("type::is_geometry", '(-0.118092, 51.509865)', True),
    ("type::is_point", '(-0.118092, 51.509865)', True),
    ("type::is_number", '123', True),
    ("type::is_object", "{ 'hello': 'world' }", True),
    ("type::is_object", "{ hello: 'world' }", True),
    ("type::is_record", "user:tobie", True),
    ("type::is_record", "user:tobie, 'test'", False),
    ("type::is_record", "user:tobie, 'user'", True),
    ("type::is_string", "'user'", True),
    ("type::is_uuid", 'u"018a6680-bef9-701b-9025-e1754f296a0f"', True),
